...
use College\Sections\{ SectionsDto, SectionsModel, SectionsController };
...
class SectionsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("College\Sections\ISectionsService");
