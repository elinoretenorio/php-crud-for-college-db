...
use College\Persons\{ PersonsDto, PersonsModel, PersonsController };
...
class PersonsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            "person_id" => 5333,
            "person_phone_number" => "theory",
            "person_name" => "drive",
        ];
        $this->dto = new PersonsDto($this->input);
        $this->model = new PersonsModel($this->dto);
        $this->service = $this->createMock("College\Persons\IPersonsService");
        $this->request = $this->createMock("Psr\Http\Message\ServerRequestInterface");
        $this->stream = $this->createMock("Psr\Http\Message\StreamInterface");
        $this->controller = new PersonsController(
            $this->service
        );
